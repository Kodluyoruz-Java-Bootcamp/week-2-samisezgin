...
public class Main
{
	public static void main(String[] args)
	{
		...
		r1.setDistrict("maltepe");
		r1.setTitle("Lorem ipsum dolor sit amet1");
		...
		r2.setDistrict("etimesgut");
		r2.setTitle("Lorem ipsum dolor sit amet2");
		r2.setRealtyType(RealtyType.HOUSE);
		r2.setUser(user2);
		r2.setCategory(RealtyCategory.SALE);
		
		Realty r3 = new Realty();
		r3.setProvince("izmir");
		r3.setDistrict("bergama");
		r3.setTitle("Lorem ipsum dolor sit amet3");
		r3.setRealtyType(RealtyType.HOUSE);
		r3.setUser(user2);
		...
		System.out.println(realtyService.getHouseNumberInProvince("istanbul", RealtyCategory.SALE));
		...
		System.out.println("Total izmir ankara istanbul : "
				+ realtyService.getRealtyNumberInProvince(List.of("istanbul", "ankara", "izmir")));
